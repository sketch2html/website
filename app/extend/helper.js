...
<meta charset="UTF-8"/>
<title>${(data.title || 'sketch2html')}</title>
...
<div id="g-top">
  <div class="g-wrap">
    ...
    <ul class="i fn-clear">
      ${ uid
        ? `<li><a href="${ this.app.config.hostMy }"><img src="${ this.img(this.ctx.session.headUrl || '//sketch2code.net/head/default.png', 64, 64, 80) }"/>${ this.ctx.session.nickname }</a></li>
